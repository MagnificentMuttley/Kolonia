...
void Fill_Arrays()
{
 ...
 // People(tax)
																{ int tab0[1] = { ID_Food };
	tPeople[0] = new People(3, tab0, 1); }	/* Pioneers */		{ int tab1[3] = { ID_Food, ID_Cloth, ID_Sugar };
	tPeople[1] = new People(4, tab1, 3); }	/* Settlers	*/		{ int tab2[5] = { ID_Food, ID_Cloth, ID_Sugar, ID_Liquor, ID_Spices };
	tPeople[2] = new People(5, tab2, 5); }	/* Citizens	*/		{ int tab3[7] = { ID_Food, ID_Cloth, ID_Sugar, ID_Liquor, ID_Spices, ID_Cocoa, ID_Tobacco_Products };
	tPeople[3] = new People(6, tab3, 7); }	/* Merchants */		{ int tab4[9] = { ID_Food, ID_Cloth, ID_Sugar, ID_Liquor, ID_Spices, ID_Cocoa, ID_Tobacco_Products, ID_Jewerly, ID_Clothes };
	tPeople[4] = new People(7, tab4, 9); }	/* Aristocrats */
